...
// Item Progression Rate Settings
RANDO_ENUM_BEGIN(RandoOptionProgressionRate)
RANDO_ENUM_ITEM(RO_PROGRESSION_RATE_UNIFORM)
RANDO_ENUM_ITEM(RO_PROGRESSION_RATE_FAST)
RANDO_ENUM_ITEM(RO_PROGRESSION_RATE_SLOW)
RANDO_ENUM_END(RandoOptionProgressionRate)

// Item Placement Style Settings
RANDO_ENUM_BEGIN(RandoOptionPlacementStyle)
RANDO_ENUM_ITEM(RO_PLACEMENT_STYLE_NEUTRAL)
RANDO_ENUM_ITEM(RO_PLACEMENT_STYLE_FORCED)
RANDO_ENUM_ITEM(RO_PLACEMENT_STYLE_LOCAL)
RANDO_ENUM_END(RandoOptionPlacementStyle)

// Key Item Priority Settings
RANDO_ENUM_BEGIN(RandoOptionKeyItemPriority)
RANDO_ENUM_ITEM(RO_KEY_PRIORITY_OFF)
RANDO_ENUM_ITEM(RO_KEY_PRIORITY_TRICKY)
RANDO_ENUM_ITEM(RO_KEY_PRIORITY_CUSTOM)
RANDO_ENUM_END(RandoOptionKeyItemPriority)

// Individual Item Priority
RANDO_ENUM_BEGIN(RandoOptionItemPriority)
RANDO_ENUM_ITEM(RO_ITEM_PRIORITY_DEFAULT)
RANDO_ENUM_ITEM(RO_ITEM_PRIORITY_EARLY)
RANDO_ENUM_ITEM(RO_ITEM_PRIORITY_LATE)
RANDO_ENUM_END(RandoOptionItemPriority)
