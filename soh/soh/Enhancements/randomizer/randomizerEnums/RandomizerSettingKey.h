...
RANDO_ENUM_ITEM(RSK_ITEM_PROGRESSION_RATE)
RANDO_ENUM_ITEM(RSK_ITEM_PLACEMENT_STYLE)
RANDO_ENUM_ITEM(RSK_KEY_ITEM_PRIORITY)
RANDO_ENUM_ITEM(RSK_KEY_PRIORITY_SLINGSHOT)
RANDO_ENUM_ITEM(RSK_KEY_PRIORITY_BOMB_BAG)
RANDO_ENUM_ITEM(RSK_KEY_PRIORITY_BOOMERANG)
RANDO_ENUM_ITEM(RSK_KEY_PRIORITY_BOW)
RANDO_ENUM_ITEM(RSK_KEY_PRIORITY_HOOKSHOT)
RANDO_ENUM_ITEM(RSK_KEY_PRIORITY_LENS_OF_TRUTH)
RANDO_ENUM_ITEM(RSK_KEY_PRIORITY_OCARINA)
RANDO_ENUM_ITEM(RSK_KEY_PRIORITY_HAMMER)
RANDO_ENUM_ITEM(RSK_KEY_PRIORITY_FIRE_ARROWS)
RANDO_ENUM_ITEM(RSK_KEY_PRIORITY_ICE_ARROWS)
RANDO_ENUM_ITEM(RSK_KEY_PRIORITY_LIGHT_ARROWS)
RANDO_ENUM_ITEM(RSK_KEY_PRIORITY_DINS_FIRE)
RANDO_ENUM_ITEM(RSK_KEY_PRIORITY_FARORES_WIND)
RANDO_ENUM_ITEM(RSK_KEY_PRIORITY_NAYRUS_LOVE)
RANDO_ENUM_ITEM(RSK_KEY_PRIORITY_IRON_BOOTS)
RANDO_ENUM_ITEM(RSK_KEY_PRIORITY_HOVER_BOOTS)
RANDO_ENUM_ITEM(RSK_KEY_PRIORITY_MAGIC_METER)
RANDO_ENUM_ITEM(RSK_KEY_PRIORITY_MIRROR_SHIELD)
RANDO_ENUM_ITEM(RSK_KEY_PRIORITY_GORON_TUNIC)
RANDO_ENUM_ITEM(RSK_KEY_PRIORITY_ZORA_TUNIC)
RANDO_ENUM_ITEM(RSK_KEY_PRIORITY_STRENGTH_UPGRADES)
RANDO_ENUM_ITEM(RSK_KEY_PRIORITY_SCALE_UPGRADES)
RANDO_ENUM_ITEM(RSK_KEY_PRIORITY_BOMBCHUS)
